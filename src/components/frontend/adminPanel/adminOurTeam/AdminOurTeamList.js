...
const AdminOurTeamList = () => {
  const {
    data: list,
    error,
    isLoading,
    isError,
  } = useGetData("ourTeam", "/ourTeam-list");
            ...
            list.data.map((item, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex justify-start md:justify-center">
                    <EditButton path={`/dashboard/ourTeam/edit/${item.id}`} />

                    <DeleteButton _key="ourTeam" path={`/ourTeam/${item.id}`} />
                  </div>
                </div>
              </div>
            ))}
...
export default AdminOurTeamList;
